...
<body>
  ...
  <div class="team-member">
    ...
    <div class="member-info">
      ...
      <p>Oversees the project's scope, timeline, and stakeholder coordination to ensure the successful implementation of GABAY.</p>
    </div>
  </div>
  ...
  <div class="team-member">
    ...
    <div class="member-info">
      ...
      <p>Designed the technical structure based on user and system requirements to ensure GABAY meets functional and performance goals.</p>
    </div>
  </div>
  ...
  <div class="team-member">
    ...
    <div class="member-info">
      ...
      <p>Developed and led the system's backend and frontend features, ensuring code quality, performance, and maintainability.</p>
    </div>
  </div>
  ...
  <div class="team-member">
    ...
    <div class="member-info">
      ...
      <p>Supported the development of modules, performed testing, and refined the user interface for optimal experience.</p>
    </div>
  </div>
</div>
